...
<template>
  <button
    ...
    class="flex min-h-[var(--size-touch-target)] min-w-[var(--size-touch-target)] flex-col items-center justify-center gap-1 border border-border bg-surface px-1 text-center text-white rounded-cta touch-manipulation select-none active:bg-white/15 disabled:opacity-30"
    @pointerdown="press"
  >
