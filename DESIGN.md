...
- **Ce que l'exception NE dit PAS.** Elle ne rouvre ni les tuiles, ni la barre latérale, ni le récap, ni les bandeaux : ils restent à angles vifs. Elle ne vaut que pour la mise en page du **scoreboard**, le seul écran que Nathan a demandé à découper.
