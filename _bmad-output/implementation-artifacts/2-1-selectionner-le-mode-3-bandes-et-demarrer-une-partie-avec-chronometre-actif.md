...
- [ ] **Task 5 — Specs, retrait de la pause et trous de planification (AC: 10)**
...
- **Reste à faire** : Task 6 (passe visuelle Chrome 1024×768 et 768×1024 avec le harnais iframe — vérifier notamment que l'anneau `w-full` ne pousse pas ANNULER/ÉCHANGER hors écran en portrait, sinon `w-4/5`), puis Task 7 (contrôle final) et passage en `review`.
