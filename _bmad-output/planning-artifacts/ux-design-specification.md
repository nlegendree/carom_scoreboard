...
| `--color-panel-yellow-band` | ~~`#E6B000`~~ **`#E6CA00`** | bandeau haut de la carte jaune *(valeur réelle du code, figée à la passe contraste de la 10.7 : encre noire à **12,81:1**)* |
