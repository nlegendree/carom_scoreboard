...
> **(j)** le liseré de tour est un **overlay** posé après les quatre zones, et non un `ring` de racine : une ombre interne se peint sous les enfants, et le bandeau opaque l'effaçait sur les 22 % hauts de la carte (défaut mesuré à la passe navigateur, invisible en test).
